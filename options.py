...
parser.add_argument(
    "--batch_size", type=int, default=4, help="Batch size to use per GPU"
)
parser.add_argument(
    "--lr", type=float, default=3e-4, help="learning rate of encoder."
)
